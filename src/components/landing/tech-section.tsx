      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid items-center gap-12 md:grid-cols-2">
          <ScrollReveal variant="fade-up">
            <div>
              <Eyebrow className="mb-4">Innovación · Datos · IA</Eyebrow>
              <h2 className="font-heading text-3xl font-extrabold leading-[1.08] tracking-tight text-white md:text-4xl lg:text-5xl">
                Abrimos las puertas a <OutlineText>tecnología</OutlineText> de otro nivel.
              </h2>
              <p className="mt-5 text-lg font-medium text-celeste">
